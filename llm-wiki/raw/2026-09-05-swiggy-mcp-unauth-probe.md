# Live probe: unauthenticated `initialize` on `https://mcp.swiggy.com/food` (2026-09-05)
...
- Served through CloudFront (Delhi PoP for this probe); India-only hosting per docs (AWS Mumbai primary, Singapore failover).
